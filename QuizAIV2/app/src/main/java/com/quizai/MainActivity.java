...
public class MainActivity extends Activity {
    ...
    private void buildUI() {
        ...
        info.setText(
            "So funktioniert es:\n\n" +
            "1️⃣  App starten\n\n" +
            "2️⃣  Permission einmal erlauben\n\n" +
            "3️⃣  Grüner 🤖 Button erscheint\n    auf deinem Bildschirm\n\n" +
            "4️⃣  Öffne deine Quiz-App\n    (TikTok, WhatsApp, egal)\n\n" +
            "5️⃣  Tippe den 🤖 Button\n\n" +
            "6️⃣  Screenshot laden → KI löst es ✅"
        );
        info.setTextSize(14);
    ...
    private void askPermission() {
        new AlertDialog.Builder(this)
            .setTitle("Eine Permission nötig")
            .setMessage(
                "QuizAI braucht die Erlaubnis über anderen Apps angezeigt zu werden.\n\n" +
                "Im nächsten Screen:\n" +
